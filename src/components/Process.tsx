...
import { Search, PenTool, Palette, Code, TestTube, Rocket, ChevronDown, CheckCircle } from 'lucide-react';

const processSteps = [
  {
    icon: Search,
    title: 'Discovery',
    description: 'We understand your practice, workflow, and specific requirements through detailed consultation.',
    duration: '1-2 weeks',
  ...
  },
  {
    icon: PenTool,
    title: 'Wireframing',
    description: 'Create detailed wireframes and user flow diagrams to map out the entire system architecture.',
    duration: '1 week',
  ...
  },
  {
    icon: Palette,
    title: 'Design',
    description: 'Design intuitive, healthcare-focused interfaces that work for both staff and patients.',
    duration: '2 weeks',
  ...
  },
  {
    icon: Code,
    title: 'Development',
    description: 'Build your custom solution using modern technologies with regular progress updates.',
    duration: '3-4 weeks',
  ...
  },
  {
    icon: TestTube,
    title: 'Testing',
    description: 'Rigorous testing including security audits, performance testing, and user acceptance testing.',
    duration: '1 week',
  ...
  },
  {
    icon: Rocket,
    title: 'Launch',
    description: 'Smooth deployment with staff training, documentation, and ongoing support setup.',
    duration: '1 week',
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-sm text-teal-600 font-medium">{step.duration}</div>
                </div>
                <motion.div
              ...
              <AnimatePresence>
                {activeStep === index && (
                  ...
                  >
                    <h4 className="font-semibold text-slate-800 mb-3 text-sm">What we deliver:</h4>
                    <ul className="space-y-2">
                      {step.details.map((detail, detailIndex) => (
                        ...
                        >
                          <CheckCircle className="text-teal-500 flex-shrink-0 mt-0.5" size={12} />
                          <span>{detail}</span>
                        </motion.li>
                      ))}
                    </ul>
...
>
  <div className="text-center">
    ...
    <div className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4">6-8 Weeks</div>
    <p className="text-teal-100 text-base md:text-lg max-w-2xl mx-auto mb-6 md:mb-8">
      From initial consultation to final deployment, most healthcare software 
      projects are completed within 6-8 weeks with ongoing support included.
    </p>
  </div>
      ...
      <div className="flex space-x-3">
        {processSteps.map((step, index) => (
          ...
          >
            ...
            <div className="text-xs font-medium text-center mb-1">{step.title}</div>
            <div className="text-xs text-teal-200 text-center">{step.duration}</div>
          </motion.div>
        ))}
      </div>
    </div>
  ...
  <div className="text-center">
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="bg-white text-teal-600 px-6 py-3 md:px-8 md:py-4 rounded-full text-base md:text-lg font-semibold hover:bg-slate-50 transition-colors"
    >
